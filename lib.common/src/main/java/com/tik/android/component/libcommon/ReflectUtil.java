 ...
 * 类名 ReflectUtil
 * 作者 Qussay Najjar
 * 功能 Utility class that uses {@code java.lang.reflect} standard library.
 ...
 * 创建日期 2014/04/13 11:33
 * 修改日期 2017/11/1 11:33
 */
...
public class ReflectUtil {
     ...
     *
     * @see {@link ReflectUtil#getClassName(Type)}
     */
     ...
     * with {@link ReflectUtil#TYPE_NAME_PREFIX}. This method will substring it, for it to be eligible
    ...
    public static Type[] getParameterizedTypes(Object object) {
        ...
        if (!ParameterizedType.class.isAssignableFrom(superclassType.getClass())) {
            superclassType =object.getClass().getSuperclass().getGenericSuperclass();
            if (!ParameterizedType.class.isAssignableFrom(superclassType.getClass())) {
                return null;
            }
        }
