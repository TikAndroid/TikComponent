...
import com.tik.android.component.widget.util.ColorEvaluator;
import com.tik.android.component.widgetkit.R;

import java.util.ArrayList;

/**
 * Created by jianglixuan on 2018/12/3
 */
public class HoxTabLayout extends ConstraintLayout implements View.OnClickListener {
    ...
    public HoxTabLayout(Context context) {
        this(context, null);
    }

    public HoxTabLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HoxTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
